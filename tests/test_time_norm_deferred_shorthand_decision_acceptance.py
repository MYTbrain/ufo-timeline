...
from scripts.accept_time_norm_deferred_shorthand_decisions import (
    ACCEPTANCE_POLICY,
    accept_time_norm_deferred_shorthand_decisions,
)


def _candidate(decision_id="erdtns_1", review_item_id="review_1"):
    return {
...
def test_accept_deferred_shorthand_decisions_requires_preview_and_dry_run_gates():
...
def test_accept_deferred_shorthand_decisions_rejects_invalid_preview_output():
...
def test_accept_deferred_shorthand_decisions_rejects_duplicate_review_items():
    with pytest.raises(ValueError, match="duplicate_review_item"):
        accept_time_norm_deferred_shorthand_decisions(
            decision_candidates=[_candidate("erdtns_1", "review_1"), _candidate("erdtns_2", "review_1")],
