...
assert.match(indexSource, /styles\.css\?v=2026-08-04-analysis-witness-count-v1/, "shared icon CSS uses the cache-safe witness-count release key");
assert.match(indexSource, /app\.js\?v=2026-08-04-analysis-witness-count-v1/, "the application runtime uses the cache-safe witness-count release key");
