...
assert.match(indexSource, /styles\.css\?v=2026-08-10-control-panel-polish-v2/, "shared icon CSS uses the current cache-safe shell key");
assert.match(indexSource, /app\.js\?v=2026-08-10-control-panel-polish-v2/, "the application runtime uses the current cache-safe shell key");
