...
def _write_coordinate_evidence_manifest_stub(root: Path) -> None:
    value = {
        "releaseId": "analysis-coordinate-evidence-test-v1",
        "assetBaseUrl": "https://assets.example.test/releases/analysis-coordinate-evidence-test-v1",
        "delivery": {
            "pagesFiles": ["manifest.json"],
    ...
    _write(root / "data" / "analysis_coordinate_evidence_v1" / "manifest.json", json.dumps(value).encode("utf-8"))


def _write_time_of_day_manifest_stub(root: Path) -> None:
    value = {
        "releaseId": "analysis-time-of-day-test-v1",
        "assetBaseUrl": "https://assets.example.test/releases/analysis-time-of-day-test-v1",
        "delivery": {
            "pagesFiles": ["manifest.json"],
