...
Wave 9 is active under its pre-implementation registration. It is limited to one measured dashboard-height or core-task refinement that improves the same metric by at least 10 percent without hiding required evidence, reducing readability, weakening accessibility, or changing scientific semantics.
